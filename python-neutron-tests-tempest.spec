...
Provides: python%{pyver}-networking-sfc-tests-tempest = 9.0.0-%{release}
...
rm -rf %{module}/{neutron_dynamic_routing,vpnaas}
...
%changelog
* Mon Mar 30 2020 Bernard Cafarelli <bcafarel@redhat.com> 0.9.0-2
- Remove stadium projects tests that were moved in later releases
...
* Mon Sep 30 2019 RDO <dev@lists.rdoproject.org> 0.6.0-1
- Update to 0.6.0
